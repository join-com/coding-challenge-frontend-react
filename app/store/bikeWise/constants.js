...
export const LOAD_ITEMS_SUCCESS = 'actions/bikeWise/LOAD_ITEMS_SUCCESS';
export const SET_PAGE = 'actions/bikeWise/SET_PAGE';
export const SET_TOTAL = 'actions/bikeWise/SET_TOTAL';
